                            ...
                            <?php if ($GLOBALS['payment_gateway'] == 'AuthorizeNet') { ?>
                                <form id="paymentForm" method="post" action="./front_payment_cc.php">
                                    ...
                                    <fieldset>
                                        <!-- Cardholder Name -->
                                        <div class="form-group">
                                            <label class="control-label"><?php echo xlt('Name on Card'); ?></label>
                                            <div class="controls">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <h5 id="cardtype" style="color:#cc0000;"><?php echo xlt('Validating') ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Expiry Date & Zip -->
                                        <div class="form-group">
                                            <label class="control-label"><?php echo xlt('Card Expiry Date and Card Holder Zip'); ?></label>
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="zip" id="cczip" type="text" class="form-control"
                                                        pattern="\d{5}" title="<?php echo xla('Enter Your Zip'); ?>"
                                        ...
                                        <!-- Hidden Fields -->
                                        <input type="hidden" name="mode" id="mode" value="Stripe" />
