...
class MentalStatusExamination extends BaseService
{
    const TABLE_NAME = "form_mental_status";
    ...
    public function __construct()
    {
        ...
        UuidRegistry::createMissingUuidsForTables(['form_mental_status']);
    }
    ...
    public function getMentalstatusForPatientForm(int $formid, $pid, $encounter)
    {
